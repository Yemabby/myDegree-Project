...
$sql="INSERT INTO studentreg (name, gender, age, address, city, nationality, pinco, phone, email, username, password, conf_pass, sec_ques, ans_secques, qualif, course)
VALUES
('$_POST[name]','$_POST[gender]','$_POST[age]','$_POST[address]','$_POST[city]','$_POST[nationality]','$_POST[pinco]','$_POST[phone]','$_POST[email]','$_POST[uname]','$_POST[pwd]','$_POST[conpwd]','$_POST[sec_ques]','$_POST[ans_secques]','$_POST[qualif]','$_POST[course]')";
