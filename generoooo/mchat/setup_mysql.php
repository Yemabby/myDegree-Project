...
Latest File Update: 2013-Sep-18
*/
@mysql_connect($DBhost='localhost', $DBusr='root', $DBpwd='') or die ('<b>Database/configuration error.</b>');
@mysql_select_db($DBname='mchat') or die ('<b>Database/configuration error (DB is missing).</b>');
